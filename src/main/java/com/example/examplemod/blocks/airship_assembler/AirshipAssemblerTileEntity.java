...
import com.example.examplemod.contraptions.AirshipContraptionEntity;
import com.example.examplemod.contraptions.AirshipContraption;
import com.example.examplemod.dimension.AirshipDimensionManager;
import com.example.examplemod.dimension.AirshipDimensionPlot;
...
public class AirshipAssemblerTileEntity extends SmartTileEntity implements IDisplayAssemblyExceptions {
    ...
    public void assemble() {
        if (this.level.getBlockState(this.worldPosition).getBlock() instanceof AirshipAssemblerBlock) {
            ...
            this.movedContraption.setPos((double)anchor.getX(), (double)anchor.getY()-1, (double)anchor.getZ());
            ...
            contraption.addBlocksToWorld(airshipWorld,new StructureTransform(this.worldPosition, 0.0F, 0, 0.0F));
            this.sendData();
        }
    }
    public void tick() {
